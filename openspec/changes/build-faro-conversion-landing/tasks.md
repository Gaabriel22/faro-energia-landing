...
- [x] 4.7 Verificar hierarquia de títulos, landmarks, links e ordem de foco
...
- [x] 5.3 Criar schema Zod compartilhado com campos, enums, normalização e limites definidos no design
- [x] 5.4 Implementar Server Action demonstrativa sem persistência, transmissão ou log de PII
- [x] 5.5 Adicionar honeypot, rejeição segura e mensagens genéricas de erro
- [x] 5.6 Implementar formulário com labels, autocomplete, erros associados, estado ocupado e anúncio de resultado
- [x] 5.7 Cobrir cálculo, validação, honeypot e estados do formulário com testes
...
- [x] 6.4 Revisar layout entre 320 px e 2560 px, orientação paisagem e zoom de 200%
- [x] 6.5 Eliminar overflow horizontal, mudanças de layout e áreas de toque inadequadas
...
- [x] 7.4 Configurar CSP, `X-Content-Type-Options`, proteção de framing, `Referrer-Policy` e `Permissions-Policy`
- [x] 7.5 Verificar ausência de segredos, PII em logs, HTML inseguro e origens desnecessárias
- [x] 7.6 Executar auditoria de dependências e corrigir vulnerabilidades aplicáveis

## 8. Inspeção e entrega

- [x] 8.1 Executar lint, typecheck, testes unitários/de componentes e build de produção
